...
/*Каждый проход в этом Fur Shader содержится в FurPass.cginc. Функция вершины создает
немного более крупная версия модели, основанная на принципе нормальной экструзии.
Кроме того, учитывается влияние силы тяжести, так что она становится более интенсивной
далее от центра*/
